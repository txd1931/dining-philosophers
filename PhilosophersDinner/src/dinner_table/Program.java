...
public class Program {
	...
	private static int simulationTime = 5000;
	private static double simulationSpeed = 100;
	...
	private static void problemSetup() {
		...
		System.out.println("Problema do Jantar dos Filósofos"
				+ "\n================================\n");
		System.out.print("Insira a quantidade de filósofos: ");
		numPhilosophers = numForks = sc.nextInt();
        philosophers = new Thread[numPhilosophers];
		signal = new int[numPhilosophers];

		System.out.print("\nInsira o tempo de simulacao em segundos: ");
